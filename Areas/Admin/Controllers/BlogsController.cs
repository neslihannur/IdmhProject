...
namespace IdmhProject.Areas.Admin.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Content,PublishedDate,AuthorId")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Content,PublishedDate,AuthorId")] Blog blog)
        {
            if (id != blog.Id)
            {
                return NotFound();
